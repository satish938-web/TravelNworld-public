    ...
    <div className="min-h-screen bg-[#f9fafb]">
      ...
      <div className="relative pt-44 pb-32 px-6 overflow-hidden bg-slate-950">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_30%,rgba(37,99,235,0.1),transparent_50%)]" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-red-600 font-bold uppercase tracking-[0.4em] text-[10px]">World-Class Escapes</span>
            <span className="w-10 h-px bg-red-600"></span>
          </motion.div>
          ...
          >
            International <span className="text-red-600 italic">Destinations</span>
          </motion.h1>
          ...
          >
            Embark on a global journey. Explore exotic beaches, modern skylines, and ancient wonders across the seven continents.
          </motion.p>
        </div>
      </div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-24">
        {source.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-40 text-center">
            <HiOutlineGlobeAlt className="text-slate-200 text-8xl mb-6" />
            ...
            {visibleDestinations.map((place, index) => (
              ...
              >
                <div className="relative h-80 rounded-3xl overflow-hidden shadow-xl border border-slate-200 bg-white transition-all duration-500 hover:shadow-red-600/10 hover:border-red-200">
                  <img 
                    src={getImageUrl(place.image) || "https://images.unsplash.com/photo-1436491865332-7a61a109c055?q=80&w=800&auto=format&fit=crop"} 
                    alt={place.title}
                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                    onError={(e) => { e.target.src = "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?q=80&w=800&auto=format&fit=crop"; }}
                  />
